                  ...
                  children: [
                    ...
                    _SlideIn(
                      ...
                      child: Padding(
                        ...
                        child: Text('Stay updated with your activity',
                            style: TextStyle(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF3B82F6)
                  .withOpacity(_pressed ? 0.25 : n.isUnread ? 0.15 : 0.05),
              blurRadius: 20,
            ),
          ],
        ),
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(n.icon, color: const Color(0xFF60A5FA), size: 20),
            ),
            const SizedBox(width: 12),
