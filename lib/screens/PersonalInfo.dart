...
class _PersonalInfoScreenState extends State<PersonalInfoScreen>
  ...
  void handleSexChange(String value) {
    setState(() {
      formData['sex'] = value;
      sexError = value.isEmpty ? 'Please select your sex' : '';
    });
  }
          ...
          child: SafeArea(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _buildSexOption('male', 'Male', Icons.male_rounded),
                const SizedBox(height: 10),
                _buildSexOption('female', 'Female', Icons.female_rounded),
                const SizedBox(height: 10),
                _buildSexOption('other', 'Other', Icons.person_rounded),
  ...
  Widget formCard() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          buildField('Full Name', 'fullName', 'Enter your full name'),
          const SizedBox(height: 16),
          buildField('Username', 'username', 'Enter your username'),
          const SizedBox(height: 16),
          buildAgeField(),
          const SizedBox(height: 16),
          buildPhoneField(),
